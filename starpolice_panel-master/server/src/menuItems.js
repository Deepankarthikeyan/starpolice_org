...
export const ADMIN_MENU_ITEMS = [
  ...
  { to: "staff-performance", permission: "admin:staff-performance", label: "Staff Performance" },
  { to: "my-performance", permission: "admin:dashboard", label: "My Performance", staffOnly: true },

...
const airForceTrustPoints = [
  { icon: "flight", label: "Air Force career preparation" },
...
const airForceCourseTopics = [
  {
    title: "Air Force Recruitment Overview",
    text: "Understand the recruitment stages, eligibility norms, documentation needs, and the service expectations for Indian Air Force aspirants.",
    icon: "badge",
    image: "/assets/images/courses/course-indian-air-force.jpg",
  },
  {
    title: "Written Exam Preparation",
    text: "Receive guided support for general awareness, reasoning, arithmetic, and current affairs required for the written test.",
    icon: "menu_book",
    image: "/assets/images/courses/course-indian-air-force.jpg",
  },
  {
  ...
  },
  {
    ...
    text: "Develop confidence, professionalism, and communication that support success in air force interviews and service.",
...
const airForceCourseFeatures = [
  "Air Force-focused study planning",
...
const airForceSelectionSteps = [
  ...
  { step: 4, title: "Medical Examination", text: "Get ready for medical checks and health verification as per Air Force requirements.", icon: "health_and_safety" },
  ...
  { step: 6, title: "Final Allocation", text: "Prepare for final selection and training allocation with step-by-step support.", icon: "flight" },
];

const airForceEligibilityRows = [
  { label: "Age", value: "As per the latest Indian Air Force recruitment notification and official guidelines" },
  { label: "Education", value: "Minimum qualification as per the current Air Force recruitment announcement" },
  ...
  return (
    <div className="react-wrapper-inner exact-home-page si-landing-page">
          ...
          <div className="row g-4 spa-main-hero__row">
            <div className="col-lg-7 spa-main-hero__col">
              <div className="spa-main-hero__content">
                <span className="spa-main-hero__eyebrow">Indian Air Force</span>
                <h1 className="spa-main-hero__title">Indian Air Force Preparation Programme</h1>
                <p className="spa-main-hero__text">
                  Prepare for the Indian Air Force with focused guidance on written exams, physical fitness, medical readiness, and online study resources.
                </p>
                <ul className="spa-main-hero__highlights">
                  <li><span aria-hidden="true" className="material-symbols-outlined">check_circle</span>Structured Air Force preparation</li>
            ...
            <div className="col-lg-5 spa-main-hero__col">
              <div className="spa-main-hero__card spa-main-hero__card--photo">
                <img src="/assets/images/courses/course-indian-air-force.jpg" alt="Indian Air Force coaching" />
                <h3>Indian Air Force Coaching Support</h3>
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-5">
              ...
              <h2 className="spa-section-title">Why Star Police Academy for Air Force Preparation?</h2>
              <p className="spa-section-text" style={{ marginLeft: 0, maxWidth: "none" }}>
                We guide aspirants with an organized preparation plan that covers written study, physical training, medical readiness, and online resources for the Indian Air Force pathway.
              </p>
            </div>
            <div className="col-lg-7">
              <div className="spa-feature-grid">
                {airForceTrustPoints.map((item) => (
      ...
      <section className="pt---100 pb---100">
        <div className="container">
          <div className="spa-section-head text-center">
            ...
            <h2 className="spa-section-title">Indian Air Force Course Structure</h2>
            <p className="spa-section-text">
              A complete preparation model for Air Force aspirants with structured guidance and online resources.
            </p>
          </div>
          <SiCourseTopicsSlider topics={airForceCourseTopics} />
        </div>
      </section>
        ...
        <div className="container p-relative">
          <div className="spa-section-head text-center">
            ...
            <p className="spa-section-text spa-section-text--light">
              Key support pillars for the Indian Air Force preparation journey.
            </p>
          </div>
          <div className="spa-feature-grid si-landing-feature-band pt---30">
            {airForceCourseFeatures.map((feature) => (
      ...
      <section className="spa-lizard-process pt---120 pb---120">
        <div className="container">
          <div className="spa-section-head text-center">
            <h2 className="spa-section-title">Indian Air Force Selection Journey</h2>
            <p className="spa-section-text">
              A clear view of the stages that aspirants must prepare for in the Air Force selection process.
            </p>
          </div>
          <div className="spa-lizard-process__track">
            {airForceSelectionSteps.map((step, index) => (
      ...
      <section className="pt---100 pb---100">
        <div className="container">
          <div className="spa-section-head text-center">
            <span className="spa-section-eyebrow">Air Force Eligibility</span>
            <h2 className="spa-section-title">Eligibility Overview</h2>
            <p className="spa-section-text">
              Key eligibility points to keep in mind before starting your Indian Air Force preparation plan.
            </p>
          </div>
          <div className="si-landing-table-wrap pt---30">
            <table className="si-landing-table">
              ...
              <tbody>
                {airForceEligibilityRows.map((row) => (
                  <tr key={row.label}>
        ...
        <div className="container">
          ...
          <div className="si-landing-table-wrap pt---30">
            <table className="si-landing-table">
              ...
              <tbody>
                {airForcePhysicalEvents.map((event) => (
                  <tr key={event.title}>
                    <th scope="row">

...
const rpfTrustPoints = [
  { icon: "security", label: "Railway security preparation" },
...
const rpfCourseTopics = [
  {
    title: "RPF Recruitment Overview",
    text: "Understand the recruitment stages, eligibility norms, documentation needs, and service expectations for RPF aspirants.",
    icon: "badge",
  ...
  },
  {
    ...
    text: "Develop confidence, professionalism, and communication that support success in RPF interviews and service.",
...
const rpfCourseFeatures = [
  "RPF-focused study planning",
...
const rpfSelectionSteps = [
  ...
  { step: 4, title: "Medical Examination", text: "Get ready for medical checks and health verification as per RPF requirements.", icon: "health_and_safety" },
  ...
  { step: 6, title: "Final Allocation", text: "Prepare for final selection and training allocation with step-by-step support.", icon: "security" },
];

const rpfEligibilityRows = [
  { label: "Age", value: "As per the latest RPF recruitment notification and official guidelines" },
  { label: "Education", value: "Minimum qualification as per the current RPF recruitment announcement" },
...
export default function RpfLandingPage() {
  return (
    <div className="react-wrapper-inner exact-home-page si-landing-page">
          ...
          <div className="row g-4 spa-main-hero__row">
            <div className="col-lg-7 spa-main-hero__col">
              <div className="spa-main-hero__content">
                <span className="spa-main-hero__eyebrow">Railway Protection Force</span>
                <h1 className="spa-main-hero__title">RPF Preparation Programme</h1>
                <p className="spa-main-hero__text">
                  Prepare for the RPF with focused guidance on written exams, physical fitness, medical readiness, and online study resources.
                </p>
                <ul className="spa-main-hero__highlights">
                  <li><span aria-hidden="true" className="material-symbols-outlined">check_circle</span>Structured RPF preparation</li>
            ...
            <div className="col-lg-5 spa-main-hero__col">
              <div className="spa-main-hero__card spa-main-hero__card--photo">
                <img src="/assets/images/courses/course-rpf.jpg" alt="RPF coaching" />
                <h3>RPF Coaching Support</h3>
        ...
        <div className="container">
          <div className="row align-items-center g-5">
            <div className="col-lg-5">
              ...
              <h2 className="spa-section-title">Why Star Police Academy for RPF Preparation?</h2>
              <p className="spa-section-text" style={{ marginLeft: 0, maxWidth: "none" }}>
                We guide aspirants with an organized preparation plan that covers written study, physical training, medical readiness, and online resources for the RPF pathway.
              </p>
            </div>
            <div className="col-lg-7">
              <div className="spa-feature-grid">
                {rpfTrustPoints.map((item) => (
      ...
      <section className="pt---100 pb---100">
        <div className="container">
          <div className="spa-section-head text-center">
            ...
            <h2 className="spa-section-title">RPF Course Structure</h2>
            <p className="spa-section-text">
              A complete preparation model for RPF aspirants with structured guidance and online resources.
            </p>
          </div>
          <SiCourseTopicsSlider topics={rpfCourseTopics} />
        </div>
      </section>
        ...
        <div className="container p-relative">
          <div className="spa-section-head text-center">
            ...
            <p className="spa-section-text spa-section-text--light">
              Key support pillars for the RPF preparation journey.
            </p>
          </div>
          <div className="spa-feature-grid si-landing-feature-band pt---30">
            {rpfCourseFeatures.map((feature) => (
      ...
      <section className="spa-lizard-process pt---120 pb---120">
        <div className="container">
          <div className="spa-section-head text-center">
            <h2 className="spa-section-title">RPF Selection Journey</h2>
            <p className="spa-section-text">
              A clear view of the stages that aspirants must prepare for in the RPF selection process.
            </p>
          </div>
          <div className="spa-lizard-process__track">
            {rpfSelectionSteps.map((step, index) => (
      ...
      <section className="pt---100 pb---100">
        <div className="container">
          <div className="spa-section-head text-center">
            <span className="spa-section-eyebrow">RPF Eligibility</span>
            <h2 className="spa-section-title">Eligibility Overview</h2>
            <p className="spa-section-text">
              Key eligibility points to keep in mind before starting your RPF preparation plan.
            </p>
          </div>
